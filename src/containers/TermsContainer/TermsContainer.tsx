    ...
    <ol>
      ...
      <li value="1">
        <span>
          ...
          ink.community (the &apos;Vendor&apos;) grants to the user (the
          &apos;Licensee&apos;) a non-exclusive and non-transferable license
          (the &apos;License&apos;) to use ink.community (the
          &apos;Software&apos;).
        </span>
        <span>
          <br />
      ...
      <li value="4">
        <span>
          This Agreement grants a site license to the Licensee. The Software may
          be loaded onto a maximum of none computers.
        </span>
        <span>
          <br />
        </span>
      ...
      <li value="7">
        <span>
          Failure to comply with any of the terms under the License section will
      ...
      <li value="9">
        <span>
          ...
          &apos;as is&apos;. Liability of the Vendor will be limited to a
      ...
      <li value="13">
        <span>
          ...
          to be accepted by the Licensee (&apos;Acceptance&apos;) on
      ...
      <li value="16">
        <span>
          ...
          or is in breach of this Agreement. On termination of this Agreement
          for any reason, the Licensee will promptly destroy the Software or
      ...
      <li value="17">
        <span>
          ...
          whole or in part due to Force Majeure, such as earthquake, typhoon,
      ...
      <li value="22">
        <span>
          ...
          that court to render the provision reasonable and enforceable and the
      ...
      <li value="23">
        <span>
          ...
          which may have been made by any party to this Agreement may in some
          way be inconsistent with this final written Agreement. All such
      ...
      <li value="25">
        <span>
          ...
          <br />
          ink.community: _________________________
        </span>
        <span>
          <br />
        </span>
